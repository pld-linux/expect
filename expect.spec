...
%description -l pl
Expect to narzЙdzie do automatyzacji interakcji z aplikacjami takimi
jak telnet, ftp, passwd, fsck, rlogin, tip itp. Expect pozwala w Ёatwy
sposСb przy pomocy skryptu kontrolowaФ inny program.
...
pour un script de contrТler un autre programme et d'interagir avec
lui.
...
Ten pakiet zawiera expectk, ktСry jest rozszerzeniem dla Tk takim jak
expect jest dla Tcl.
